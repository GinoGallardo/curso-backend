...
// const listaProductos = [...new Set(objetos.flatMap(objeto => Object.keys(objeto)))];
// console.log(listaProductos);

// const totalVendidos = Object.values(objetos.reduce((accumulator, objeto) => {
//   Object.entries(objeto).forEach(([producto, cantidad]) => {
//     accumulator[producto] = (accumulator[producto] || 0) + cantidad;
//   });
//   return accumulator;
